...
namespace supa.Controllers
{
    ...
    public class SUPACatPeriodosController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<SUPACatPeriodos>> PostSUPACatPeriodos(SUPACatPeriodosViewModel viewModel)
        {
            ...
            try
            {
                var parameters = new[]
                {
                    new SqlParameter("@DescripcionPeriodo", (object)viewModel.DescripcionPeriodo ?? DBNull.Value),
                    new SqlParameter("@FechaInicio", (object)viewModel.FechaInicio ?? DBNull.Value),
                    new SqlParameter("@FechaTermino", (object)viewModel.FechaTermino ?? DBNull.Value)
                };
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSUPACatPeriodos(int id, SUPACatPeriodosViewModel viewModel)
        {
            if (viewModel.IdCatPeriodos.HasValue && id != viewModel.IdCatPeriodos.Value)
